...
public class CustomizedResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public final ResponseEntity<Object> handleIllegalStateException(UserNotFound ex, WebRequest request) {
                   
		ExceptionResponse e = new ExceptionResponse(new Date(),"Validation Failed",
				ex.getMessage());
		return new ResponseEntity<Object>(e, HttpStatus.INTERNAL_SERVER_ERROR);
